...
public class DepartmentListView extends VerticalLayout {
    ...
    public void configureGrid() {
        ...
        grid.setColumns("departmentId", "departmentName");
        ...
        grid.addColumn(department -> department.isClosed() ? "Closed" : "Active").setHeader("Status").setSortable(true);
        grid.setClassNameGenerator(department -> department.isClosed() ? "false" : "true");
    }
